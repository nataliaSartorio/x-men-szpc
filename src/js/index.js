...
personagens.forEach((personagem) => {
    personagem.addEventListener ('mouseenter', () => {
        ...
        /*personagem.classList.add('selecionado'); incluido no passo tres para nao travar o site*/
...
/* passo 2 - alterar a imagem do personagem grande */ /*ATENÇÃO!! É USADO `` para abrir e fechar*/
